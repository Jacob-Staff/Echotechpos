                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($row['status'] === 'Pending'): ?>
                                <form class="inline" method="post" onsubmit="return confirm('Approve this loan?');">
                                    <input type="hidden" name="action" value="approve_loan">
                                    <input type="hidden" name="id" value="<?= (int)$row['id'] ?>">
                                    <button class="btn success" type="submit" title="Approve"><i class="fa-solid fa-check"></i></button>
                                </form>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row-actions">
                            <?php if ($row['status'] === 'Pending'): ?>
                                <form class="inline" method="post" onsubmit="return confirm('Approve this salary advance?');">
