...
/* TEMPORARY DIAGNOSTIC: expose the exact PHP fatal instead of a blank HTTP 500.
   Remove this block after the root cause is identified. */
register_shutdown_function(function (): void {
    ...
    if ($error && in_array($error['type'], [E_ERROR, E_PARSE, E_CORE_ERROR, E_COMPILE_ERROR], true)) {
        ...
        echo "\n\nEchoTech Compliance PHP FATAL DIAGNOSTIC\n";
