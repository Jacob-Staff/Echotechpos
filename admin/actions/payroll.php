...
<form method="post" action="/admin/actions/payroll.php" id="salaryTemplateForm" onsubmit="return prepareSalaryTemplate()">
...
<form method="post" action="/admin/actions/payroll.php" class="remit-form">
