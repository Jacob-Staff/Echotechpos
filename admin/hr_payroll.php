...
if ($payrollRole !== 'Human Resource') {
    http_response_code(403);
    exit('Access denied. Payroll is restricted to Human Resource.');
}
...
<span class="status calculated">Prepared — Awaiting Admin Final Approval</span>
<?php else: ?>
