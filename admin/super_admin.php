...
/**
 * EchoTech POS — PLATFORM SUPER ADMIN
 *
...
/* ---------------------------------------------------------------
 * Authentication — completely separate from pharmacy Admin.
 * ------------------------------------------------------------- */
...
</style></head><body><section class="login"><div class="brand">EchoTech Platform Control Center</div><div class="sub">Super Admin authentication · 24-hour rolling inactivity session</div>
...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <a class="<?=sa_nav_active('dashboard',$tab)?>" href="?tab=dashboard"><i>⌂</i>Dashboard</a>
        <a class="<?=sa_nav_active('pharmacies',$tab)?>" href="?tab=pharmacies"><i>▣</i>Pharmacies</a>
        <a class="<?=sa_nav_active('branches',$tab)?>" href="?tab=branches"><i>⌘</i>Branches</a>
        <a class="<?=sa_nav_active('users',$tab)?>" href="?tab=users"><i>♙</i>Staff & Users</a>
        <a class="<?=sa_nav_active('permissions',$tab)?>" href="?tab=permissions"><i>☷</i>Permissions</a>
        <a class="<?=sa_nav_active('audit',$tab)?>" href="?tab=audit"><i>◌</i>Audit & Security</a>
        <a class="<?=sa_nav_active('security',$tab)?>" href="?tab=security"><i>⚿</i>Super Admins</a>
        <a class="<?=sa_nav_active('health',$tab)?>" href="?tab=health"><i>♥</i>System Health</a>
    </nav>
...
<div class="stat"><div class="label">Staff Users</div><div class="value"><?=number_format((int)$stats['users'])?></div><div class="meta"><?=number_format((int)$stats['active_users'])?> active · <?=number_format((int)$stats['frozen_users'])?> frozen</div></div>
...
<?php if($tempPassword!==''): ?><div class="temp"><strong>Temporary password — copy it now:</strong> <code><?=sa_h($tempPassword)?></code><div style="margin-top:5px">This value is displayed once by the Super Admin interface.</div></div><?php endif; ?>
