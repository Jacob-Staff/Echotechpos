        ...
        if ($account) {
            ...
            if ($token) {
                ...
                $html = '<div style="font-family:Arial,sans-serif;max-width:600px">'
                    . '<h2 style="margin:0 0 20px">EchoTech</h2>'
                    . '<p>Hello ' . $safeName . ',</p>'
                    . '<p>We received a request to reset your password.</p>'
                    . '<p><a href="' . $safeUrl . '" style="display:inline-block;padding:12px 18px;background:#246bfe;color:#fff;text-decoration:none;border-radius:8px">Reset Password</a></p>'
                ...
                if (!$mailSent) {
                    error_log('EchoTech password reset: token created but email delivery failed for staff account ID ' . (int)$account['id']);
                }
            }
        }

        // Deliberately generic: do not reveal whether a username/email exists.
        $success = true;
