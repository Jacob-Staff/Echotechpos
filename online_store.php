...
if (isset($_GET['bid'])) {
    $_SESSION['branch_id'] = intval($_GET['bid']); // Secure casting to Integer
...
// Limit for the initial grid display
        ...
        <div class="col-6 col-lg-3">
            <a href="api/upload_prescription.php?bid=<?php echo $branch_id; ?>" class="text-decoration-none">
                <div class="d-flex align-items-center p-3 bg-white border rounded shadow-sm h-100 transition-hover">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-dark" style="font-size: 13px;">Upload Prescriptions</h6>
                        <small class="text-muted" style="font-size: 11px;">Easy & Fast</small>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3">
            <a href="api/lab_results.php?bid=<?php echo $branch_id; ?>" class="text-decoration-none">
                <div class="d-flex align-items-center p-3 bg-white border rounded shadow-sm h-100 transition-hover">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-dark" style="font-size: 13px;">Lab Test Results</h6>
                        <small class="text-muted" style="font-size: 11px;">Secure Access</small>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3">
            <a href="https://wa.me/<?php echo $phone; ?>?text=I%20need%20a%20fast%20delivery" target="_blank" class="text-decoration-none">
                <div class="d-flex align-items-center p-3 bg-white border rounded shadow-sm h-100 transition-hover">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-dark" style="font-size: 13px;">Delivery in 2 HRS</h6>
                        <small class="text-muted" style="font-size: 11px;">Within Lusaka</small>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-lg-3">
            <a href="https://wa.me/<?php echo $phone; ?>?text=Do%20you%20accept%20insurance" target="_blank" class="text-decoration-none">
                <div class="d-flex align-items-center p-3 bg-white border rounded shadow-sm h-100 transition-hover">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold text-dark" style="font-size: 13px;">Health Insurance</h6>
                        <small class="text-muted" style="font-size: 11px;">Co-pay Support</small>
                    </div>
                </div>
            </a>
        </div>
...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">Shop Medicines</h4>
                ...
                <div class="product-card shadow-sm h-100 d-flex flex-column justify-content-between">
                    <a href="api/product_details.php?id=<?php echo $row['id']; ?>&bid=<?php echo $branch_id; ?>" class="product-link">
                        <div class="text-center mb-2">
                            <img src="<?php echo $img_path; ?>" class="img-fluid" style="height:85px; object-fit: contain;">
                        </div>
                        <div>
                            <div class="product-title fw-bold" style="font-size: 13px; line-height: 1.2;">
                                <?php echo $row['item_name']; ?> 
                                <br><span class="text-muted small" style="font-weight: normal;"><?php echo $row['category']; ?></span>
                            </div>
